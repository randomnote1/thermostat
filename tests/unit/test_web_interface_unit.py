...
class TestAPIEndpoints(unittest.TestCase):
    ...
    def test_sensor_update_endpoint(self):
        ...
        # Update the sensor (monitored is independent of enabled now)
        ...
        # Verify update (monitored should remain True since it wasn't changed)
        ...
        self.assertTrue(sensor['monitored'])  # Monitored is independent of enabled
